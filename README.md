...
<h3 align="center">CS Student | Fullstack & DevOps Enthusiast | Building systems from scratch</h3>
...
`Flutter` `Node.js` `JWT` `Clean Architecture`

**🧾 GERTAKESS**
A point-of-sale desktop application built with Java, JavaFX, and MySQL.
`Java` `JavaFX` `MySQL`
...
<p>
  <a href="https://badisaourtilane.netlify.app/">
    <img src="https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white"/>
  </a>
</p>

<p align="center"><i>Open to fullstack / DevOps alternance opportunities — feel free to reach out!</i></p>
